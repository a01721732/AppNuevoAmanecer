...
class Communicador3 : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_communicador3)
        ...
        btnComunicador1 = findViewById(R.id.comView21)
        btnComunicador2 = findViewById(R.id.comView22)
        btnComunicador3 = findViewById(R.id.comView23)
        btnComunicador4 = findViewById(R.id.comView24)
        btnComunicador5 = findViewById(R.id.comView25)
        btnComunicador6 = findViewById(R.id.comView26)
        btnComunicador7 = findViewById(R.id.comView27)

        btnComunicador10 = findViewById(R.id.comView28)
